  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative bg-card border border-border/50 group-hover:border-primary/50 rounded-3xl p-8 md:p-10 backdrop-blur-sm transition-all duration-300">
          ...
          <h3 className="text-3xl md:text-4xl font-bold mb-2 group-hover:text-primary transition-colors duration-300">
            {title}
          </h3>
            ...
            {features.map((feature, idx) => (
              ...
              >
                <div className="mt-0.5 flex-shrink-0">
                  <div className="w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center group-hover/item:bg-primary/20 transition-colors duration-300">
          ...
          <div className="absolute top-8 right-8 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold text-xl">
            {index + 1}
          </div>
        </div>
      </div>
